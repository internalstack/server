...
export const validators = {
		...
		options: z
			.object({
				...
				customValidator: z
					.function()
					.args(z.unknown())
					.returns(z.union([z.string(), z.literal(true)]).promise())
					.optional()
	...
	currency: {
		...
		options: z
			.object({
				...
				valueFormat: z
					.union([z.literal('number'), z.literal('string')])
					.optional()
					.default('number'),
	...
	radio: {
		...
		options: z
			.object({
				defaultValue: jsonValueValidator.optional(),
				disabled: z.boolean().optional().default(false),
				help: z.string().optional().default(''),
				customValidator: z
					.function()
		...
		options: z
			.object({
				selectionAppearance: z
					.union([z.literal('text-input'), z.literal('option')])
					.optional()
					.default('text-input'),
	...
	colorpicker: {
		...
		options: z
			.object({
				...
				help: z.string().optional().default(''),
				format: z
					.union([z.literal('hex'), z.literal('hsla'), z.literal('rgba')])
					.optional()
					.default('hex'),
				outputFormat: z
					.union([z.literal('hex'), z.literal('hsla'), z.literal('rgba')])
	...
	loading: {
		...
		options: z
			.object({
				description: z.string().optional().default(''),
				icon: z
					.union([z.literal('spinner'), z.literal('check')])
					.optional()
					.default('spinner'),
			})
			.optional()
